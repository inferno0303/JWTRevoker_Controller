...
# 步骤一
process1 = subprocess.Popen(['python', 'clean_edge_table.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE,
...
# 步骤二
process2 = subprocess.Popen(['python', 'clean_node_table.py'], stdout=subprocess.PIPE, stderr=subprocess.PIPE,
                            text=True, encoding='utf-8')
